...
class ZedCamera : public rclcpp::Node {
 ...
 protected:
  ...
  bool handleGmsl2Params(const rclcpp::Parameter &param,
                         rcl_interfaces::msg::SetParametersResult &result);
  bool handleUsb3Params(const rclcpp::Parameter &param,
                        rcl_interfaces::msg::SetParametersResult &result);
  bool handleCommonVideoParams(
      const rclcpp::Parameter &param,
      rcl_interfaces::msg::SetParametersResult &result);
  bool handleDepthParams(const rclcpp::Parameter &param,
                         rcl_interfaces::msg::SetParametersResult &result);
  // Object Detection
  bool handleOdDynamicParams(const rclcpp::Parameter &param,
                             rcl_interfaces::msg::SetParametersResult &result);
 ...
 private:
  ...
  std::unordered_map<int, sl::CustomObjectDetectionProperties>
      mCustomOdProperties;
