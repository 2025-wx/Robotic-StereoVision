...
/**
\brief Defines robot parameters, this will be used to compute the
TRAVERSABILITY_COST
*/
...
/**
        \brief Defines the traversability parameters, this will be used to
   compute the TRAVERSABILITY_COST
         */
...
namespace plane {
void compute_pca(std::vector<sl::float3> &points, sl::float3 &normal_vect,
                 sl::float3 &centroid, sl::float3 &eigen_values);
}
